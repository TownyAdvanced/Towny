...
public enum ConfigNodes {
            ...
            FILTERS_MODIFY_CHAT_FORMAT("filters_colour_chat.modify_chat.format",
            		"{townytagoverride}{townycolor}{permprefix}{group} {townyprefix}{playername}{townypostfix}{permsuffix}&f: {msg}",
            ...
            FILTERS_COLOUR_RESIDENT("filters_colour_chat.colour.mayor","&f"),
