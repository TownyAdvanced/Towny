...
public enum ConfigNodes {
	...
	PROT_POTION_TYPES(
			...
			"BLINDNESS,CONFUSION,HARM,HUNGER,POISON,SLOW,SLOW_DIGGING,WEAKNESS,WITHER,WIND_CHARGED,WEAVING,INFESTED",
			"",
			...
			"# SPEED, WATER_BREATHING, WEAKNESS, WITHER, WIND_CHARGED, WEAVING, INFESTED",
			"",
