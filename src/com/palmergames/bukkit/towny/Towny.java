...
import com.palmergames.bukkit.towny.war.siegewar.listeners.SiegeWarActionListener;
import com.palmergames.bukkit.towny.war.siegewar.listeners.SiegeWarEventListener;
...
public class Towny extends JavaPlugin {
	...
	private void registerEvents() {
		...
		if (!isError()) {
			...
			pluginManager.registerEvents(siegeWarActionListener, this);
			pluginManager.registerEvents(siegeWarEventListener, this);
		}
