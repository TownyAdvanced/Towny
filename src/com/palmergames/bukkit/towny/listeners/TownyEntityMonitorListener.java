...
public class TownyEntityMonitorListener implements Listener {
	...
	/**
	 * This handles EntityDeathEvents on MONITOR in order to loadString Towny features such as:
	 * - DeathPayments,
	 * - Jailing Players,
	...
	public void onEntityDeath(EntityDeathEvent event) throws NotRegisteredException {
		...
		if (defenderEntity instanceof Player) {
			...
			try {
				defenderResident = townyUniverse.getResident(defenderPlayer.getName());
