...
public enum ConfigNodes {
            ...
            VERSION_BUKKIT("version.bukkit_version","2126", "# Minimum required version of CraftBukkit.  Please do not edit."),
            ...
            PLUGIN_DATABASE_SQL_HEADER("plugin.database.sql","", "",
            ...
            PLUGIN_DAILY_BACKUPS_HEADER("plugin.database.daily_backups","", "",
            		"# Flatfile backup settings."),
            PLUGIN_DAILY_BACKUPS("plugin.database.daily_backups","true"),
            PLUGIN_BACKUPS_ARE_DELETED_AFTER("plugin.database.backups_are_deleted_after","90d"),
            ...
            PROT("protection","",
                    ...
                    "# +------------------------------------------------------+ #",
                    "############################################################", ""),
            PROT_ITEM_USE_ID("protection.item_use_ids","259,325,326,327,351,385",
            		"",
            ...
            WAR_ECONOMY_ENEMY_PLACE_FLAG("war.economy.enemy.place_flag", "10",
                    "# Amount charged to place a warflag (payed to server)."),
            WAR_ECONOMY_ENEMY_DEFENDED_ATTACK("war.economy.enemy.defended_attack", "10",
                    "# Amount payed from the flagbearer to the defender after defending the area."),
            WAR_ECONOMY_TOWNBLOCK_WON("war.economy.townblock_won", "10",
            ...
            WAR_ECONOMY_HOMEBLOCK_WON("war.economy.homeblock_won", "100",
            ...
            WAR_ENEMY_BEACON_HEIGHT_ABOVE_FLAG("war.enemy.beacon.height_above_flag", "",
            ...
            WAR_ENEMY_BEACON_HEIGHT_ABOVE_FLAG_MIN("war.enemy.beacon.height_above_flag.min","3"),
            WAR_ENEMY_BEACON_HEIGHT_ABOVE_FLAG_MAX("war.enemy.beacon.height_above_flag.max","64"),
