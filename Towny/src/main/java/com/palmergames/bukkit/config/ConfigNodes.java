...
public enum ConfigNodes {
	...
	ECO_PRICE_TOWN_SPAWN_TRAVEL_PUBLIC_MAXIMUM(
			...
			"# You can disable this setting with by setting price_allow_mayors_to_override_public_spawn_cost to false. This will use the price_town_public_spawn_travel option to set a mandatory price.",
			"# This is paid to the town you goto."),
