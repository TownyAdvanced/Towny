...
public class TownyMessaging {
    ...
    public static void sendPrefixedTownMessage(Town town, String line) {
        ...
        TownyLogger.log.info(ChatTools.stripColour("[Town Msg] " + town.getName() + ": " + line));
        for (Player player : TownyUniverse.getOnlinePlayers(town))
            player.sendMessage(TownyFormatter.replaceMessagePlaceholder(TownySettings.getLangString("default_town_prefix"), town.getName()) + line);
    }
    ...
    public static void sendPrefixedNationMessage(Nation nation, String line) {
        ...
        TownyLogger.log.info(ChatTools.stripColour("[Nation Msg] " + nation.getName() + ": " + line));
        for (Player player : TownyUniverse.getOnlinePlayers(nation))
            player.sendMessage(TownyFormatter.replaceMessagePlaceholder(TownySettings.getLangString("default_nation_prefix"), nation.getName()) + line);
    }
    ...
    public static void sendRequestMessage(Object player, Invite invite) {
        if (invite.getSender() instanceof Town) { // Town invited Resident
            String firstline = ChatColor.DARK_GRAY + "[" + ChatColor.GRAY + "Invitation" + ChatColor.DARK_GRAY + "] " + ChatColor.BLUE + TownyFormatter.replaceMessagePlaceholder(TownySettings.getLangString("you_have_been_invited_to_join2"), invite.getSender().getName());
        ...
        if (invite.getSender() instanceof Nation) {
            ...
            if (invite.getReceiver() instanceof Nation) { // Nation allied Nation
                String firstline = ChatColor.DARK_GRAY + "[" + ChatColor.GRAY + "Invitation" + ChatColor.DARK_GRAY + "] " + ChatColor.BLUE + TownyFormatter.replaceMessagePlaceholder(TownySettings.getLangString("you_have_been_requested_to_ally2"), invite.getSender().getName());
