...
public class NameValidation {
	...
	public static boolean isValidName(String name) {
		...
		try {
			if (namePattern == null)
				namePattern = Pattern.compile(TownySettings.getNameCheckRegex(), Pattern.CASE_INSENSITIVE);
	...
	public static boolean isValidString(String name) {
		...
		try {
			if (stringPattern == null)
				stringPattern = Pattern.compile(TownySettings.getStringCheckRegex(), Pattern.CASE_INSENSITIVE);
