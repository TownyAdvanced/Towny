...
<tr align=center><td> MC 1.19 </td><td rowspan=4> Use <a href=https://github.com/TownyAdvanced/Towny/releases/tag/0.98.3.0>0.98.3.0</a> or the <a href=https://github.com/TownyAdvanced/Towny/releases>the Latest Pre-Release.</a></td>
