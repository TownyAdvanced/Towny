...
public class NationCommand extends BaseCommand implements CommandExecutor {
	...
	private void parseNationCommandForConsole(final CommandSender sender, String[] split) throws TownyException {
		...
		if (split.length == 0 || split[0].equalsIgnoreCase("?") || split[0].equalsIgnoreCase("help")) {
			...
			try {
				final Nation nation = TownyUniverse.getInstance().getDatabase().getNation(split[0]);
	...
	public void parseNationCommand(final Player player, String[] split) {
		...
		try {
			...
			if (split.length == 0)
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_LIST.getNode()))
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_NEW.getNode()))
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_WITHDRAW.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				...
				if (TownySettings.isBankActionLimitedToBankPlots()) {
					...
					Nation pNation= TownyUniverse.getInstance().getDatabase().getResident(player.getName()).getTown().getNation();
				...
				if (TownySettings.isBankActionDisallowedOutsideTown()) {
					...
					Town town = TownyUniverse.getInstance().getDatabase().getWorld(player.getLocation().getWorld().getName()).getTownBlock(coord).getTown();
					if (!town.isCapital())
						throw new TownyException(TownySettings.getLangString("msg_err_unable_to_use_bank_outside_nation_capital"));
					Nation nation = town.getNation();
					if (!TownyUniverse.getInstance().getDatabase().getResident(player.getName()).getTown().getNation().equals(nation))
						throw new TownyException(TownySettings.getLangString("msg_err_unable_to_use_bank_outside_nation_capital"));
				}
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_LEAVE.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
			     ...
			     */
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_SPAWN.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_DEPOSIT.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				...
				if (TownySettings.isBankActionDisallowedOutsideTown()) {
					if (TownyAPI.getInstance().isWilderness(player.getLocation().getBlock()))
						throw new TownyException(TownySettings.getLangString("msg_err_unable_to_use_bank_outside_nation_capital"));
					Coord coord = Coord.parseCoord(plugin.getCache(player).getLastLocation());
					Town town = TownyUniverse.getInstance().getDatabase().getWorld(player.getLocation().getWorld().getName()).getTownBlock(coord).getTown();
					if (!town.isCapital())
				...
				if (split[0].equalsIgnoreCase("rank")) {
					...
					if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_KING.getNode()))
						throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
					...
					if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_INVITE_ADD.getNode()))
						throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
					...
					if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_KICK.getNode()))
						throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
					...
					if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_ENEMY.getNode()))
						throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
					...
					if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_DELETE.getNode()))
						throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
					...
					if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_ONLINE.getNode()))
						throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
					...
					if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_SAY.getNode()))
						throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));

					try {
						Nation nation = TownyUniverse.getInstance().getDatabase().getResident(player.getName()).getTown().getNation();
					...
					try {
						final Nation nation = TownyUniverse.getInstance().getDatabase().getNation(split[0]);
						Resident resident = TownyUniverse.getInstance().getDatabase().getResident(player.getName());
						if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_OTHERNATION.getNode()) && ( (resident.hasTown() && resident.getTown().hasNation() && (resident.getTown().getNation() != nation) )  || !resident.hasTown() )) {
							throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
						}
	...
	private void parseInviteCommand(Player player, String[] newSplit) throws TownyException {
		...
		if (newSplit.length == 0) { // (/nation invite)
			if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_INVITE_SEE_HOME.getNode())) {
				throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
			}
			String[] msgs;
		...
		if (newSplit.length >= 1) { // /town invite [something]
			...
			if (newSplit[0].equalsIgnoreCase("sent")) { //  /invite(remfirstarg) sent args[1]
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_INVITE_LIST_SENT.getNode())) {
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				}
	...
	private void parseNationOnlineCommand(Player player, String[] split) throws TownyException {
		...
		if (split.length > 0) {
			try {
				Nation nation = TownyUniverse.getInstance().getDatabase().getNation(split[0]);
	...
	public void nationRank(Player player, String[] split) throws TownyException {
		...
		if (split.length == 0) {
			...
			try {
				...
				target = TownyUniverse.getInstance().getDatabase().getResident(split[1]);
			 ...
			 * data.
			 */
			TownyUniverse.getInstance().getDatabase().saveResident(target);
	...
	public void listNations(CommandSender sender, String[] split) {
		List<Nation> nationsToSort = TownyUniverse.getInstance().getDatabase().getNations();
		...
		nationsToSort.sort((Comparator) (n1, n2) -> {
	...
	public Nation newNation(String name, Town town) throws AlreadyRegisteredException, NotRegisteredException {
		...
		TownyUniverse.getInstance().getDatabase().newNation(name);
		Nation nation = TownyUniverse.getInstance().getDatabase().getNation(name);
		nation.addTown(town);
		nation.setCapital(town);
		...
		TownyUniverse.getInstance().getDatabase().saveNationList();
	...
	public void nationLeave(Player player) {
		...
		try {
			...
			for (Resident res : titleRemove) {
				...
				TownyUniverse.getInstance().getDatabase().saveResident(res);
			}
			TownyUniverse.getInstance().getDatabase().saveNation(nation);
			TownyUniverse.getInstance().getDatabase().saveNationList();
			...
			TownyUniverse.getInstance().getDatabase().removeNation(en.getNation());
			TownyUniverse.getInstance().getDatabase().saveNationList();
	...
	public void nationAdd(Player player, String[] names) throws TownyException {
		...
		if (namestoremove.length >= 1) {
			nationRevokeInviteTown(player,nation, TownyUniverse.getInstance().getDatabase().getTowns(namestoremove));
		}

		if (names.length >= 1) {
			nationAdd(player, nation, TownyUniverse.getInstance().getDatabase().getTowns(names));
		}
	}
	...
	public void nationKick(Player player, String[] names) {
		...
		nationKick(player, resident, nation, TownyUniverse.getInstance().getDatabase().getTowns(names));
	}
	...
	private void nationAlly(Player player, String[] split) throws TownyException {
		...
		if (split[0].equalsIgnoreCase("add")) {
			...
			if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_ALLY_ADD.getNode())) {
				throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
			}
			for (String name : names) {
				try {
					ally = TownyUniverse.getInstance().getDatabase().getNation(name);
					...
					if (name.startsWith("-") && TownySettings.isDisallowOneWayAlliance()) {
						try {
							ally = TownyUniverse.getInstance().getDatabase().getNation(name.substring(1));
							if (nation.equals(ally)) {
								TownyMessaging.sendErrorMsg(player, TownySettings.getLangString("msg_own_nation_disallow"));
								return;
							} else {
		...
		if (split[0].equalsIgnoreCase("remove")) {
			if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_ALLY_REMOVE.getNode())) {
				throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
			}
			for (String name : names) {
				try {
		...
		if (TownySettings.isDisallowOneWayAlliance()) {
			...
			if (split[0].equalsIgnoreCase("sent")) {
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_ALLY_LIST_SENT.getNode())) {
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				}
			...
			if (split[0].equalsIgnoreCase("received")) {
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_ALLY_LIST_RECEIVED.getNode())) {
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				}
			...
			if (split[0].equalsIgnoreCase("accept")) {
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_ALLY_ACCEPT.getNode())) {
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				}
				Nation sendernation;
				...
				if (split.length >= 2) { // /invite deny args[1]
					try {
						sendernation = TownyUniverse.getInstance().getDatabase().getNation(split[1]);
					} catch (NotRegisteredException e) {
						TownyMessaging.sendErrorMsg(player, TownySettings.getLangString("msg_invalid_name"));
						return;
					}
			...
			if (split[0].equalsIgnoreCase("deny")) {
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_ALLY_DENY.getNode())) {
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				}
				Nation sendernation;
				List<Invite> invites = nation.getReceivedInvites();
...
//						}
		...
		if (allies.size() > 0) {
			...
			TownyUniverse.getInstance().getDatabase().saveNations();
	...
	public void nationEnemy(Player player, String[] split) {
		...
		if ((test.equalsIgnoreCase("remove") || test.equalsIgnoreCase("add")) && newSplit.length > 0) {
			for (String name : newSplit) {
				try {
					enemy = TownyUniverse.getInstance().getDatabase().getNation(name);
	...
	public void nationSet(Player player, String[] split) throws TownyException, InvalidNameException {
		...
		if (split.length == 0) {
			...
			if (split[0].equalsIgnoreCase("king")) {
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_SET_KING.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				...
				if (split.length < 2)
					...
					try {
						Resident newKing = TownyUniverse.getInstance().getDatabase().getResident(split[1]);
				...
				try {
					Town newCapital = TownyUniverse.getInstance().getDatabase().getTown(split[1]);
					...
					if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_SET_CAPITOL.getNode()))
						throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_SET_SPAWN.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_SET_TAXES.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_SET_SPAWNCOST.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_SET_NAME.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_SET_TAG.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_SET_TITLE.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				...
				if (split.length < 2)
					...
					resident = TownyUniverse.getInstance().getDatabase().getResident(split[1]);
				if (resident.hasNation()) {
					if (resident.getTown().getNation() != TownyUniverse.getInstance().getDatabase().getResident(player.getName()).getTown().getNation()) {
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_SET_SURNAME.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_SET_BOARD.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
	...
	public void nationToggle(Player player, String[] split) throws TownyException {
		...
		if (split.length == 0) {
			...
			if (split[0].equalsIgnoreCase("peaceful") || split[0].equalsIgnoreCase("neutral")) {
				...
				if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_TOGGLE_NEUTRAL.getNode()))
					throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
                ...
                if (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_NATION_TOGGLE_PUBLIC.getNode()))
                    throw new TownyException(TownySettings.getLangString("msg_err_command_disable"));
	...
	public void nationRename(Player player, Nation nation, String newName) {
		...
		try {
			TownyUniverse.getInstance().getDatabase().renameNation(nation, newName);
    ...
    public static void nationSpawn(Player player, String[] split) throws TownyException {
        ...
        try {
            ...
            if (split.length == 0) {
                ...
                // split.length > 1
                nation = TownyUniverse.getInstance().getDatabase().getNation(split[0]);
    ...
    public static void nationSpawn(Player player, String[] split, Nation nation, String notAffordMSG) {
        ...
        try {
            boolean isTownyAdmin = TownyUniverse.getInstance().getPermissionSource().has(player, PermissionNodes.TOWNY_COMMAND_TOWNYADMIN_NATION_SPAWN_OTHER.getNode());
            Resident resident = TownyUniverse.getInstance().getDatabase().getResident(player.getName());
            Location spawnLoc;
...
//            }
            ...
            if (!isTownyAdmin) {
                ...
                if (!disallowedZones.isEmpty()) {
                    ...
                    if (inTown != null && resident.hasNation() && TownyUniverse.getInstance().getDatabase().getTown(inTown).hasNation()) {
                        Nation inNation = TownyUniverse.getInstance().getDatabase().getTown(inTown).getNation();
                        Nation playerNation = resident.getTown().getNation();
            ...
            if ( (!TownyUniverse.getInstance().getPermissionSource().testPermission(player, PermissionNodes.TOWNY_COMMAND_TOWNYADMIN_TOWN_SPAWN_FREECHARGE.getNode())) &&
