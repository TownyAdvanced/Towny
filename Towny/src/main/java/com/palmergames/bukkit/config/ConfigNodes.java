...
public enum ConfigNodes {
	...
	PLUGIN_ENABLED_CONTEXTS(
			...
			"# towny:nationrank, towny:town, towny:nation, towny:istownconquered, towny:plot_type_at_player"
	),
	...
	ECO_PRICE_DEATH_PAY_KILLER_ON_PVP("economy.death.price_paid_to_killer_on_pvp",
			"true",
			"",
	...
	ECO_PRICE_DEATH("economy.death.price_death",
			"1.0",
			"",
			"# The price that a player pays when they die.",
	...
	ECO_PRICE_DEATH_TOWN("economy.death.price_death_town",
			"0.0",
			"",
			"# The price that a player's town pays when they die.",
			"# Either a flat rate or a percentage according to the price_death_type setting."),
	ECO_PRICE_DEATH_NATION("economy.death.price_death_nation",
			"0.0",
			"",
			"# The price that a player's nation pays when they die.",
			"# Either a flat rate or a percentage according to the price_death_type setting."),
