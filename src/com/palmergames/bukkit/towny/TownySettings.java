...
public class TownySettings {
	...
	public static int getMaxResidentPlotsExtra(Resident resident) {

		int extraPlots = TownyUniverse.getPermissionSource().getGroupPermissionIntNode(resident.getName(), PermissionNodes.TOWNY_EXTRA_PLOTS.getNode());
		if (extraPlots == -1)
			extraPlots = 0;
		return extraPlots;
	}
