...
public enum PermissionNodes {
	...
	TOWNY_COMMAND_TOWNYADMIN_TOWN("towny.command.townyadmin.town.*"),
		...
		TOWNY_COMMAND_TOWNYADMIN_TOWN_SETFOUNDINGDATE("towny.command.townyadmin.town.setfoundingdate"),
	...
	TOWNY_COMMAND_TOWNYADMIN_NATION("towny.command.townyadmin.nation.*"),
		...
		TOWNY_COMMAND_TOWNYADMIN_NATION_SETFOUNDINGDATE("towny.command.townyadmin.nation.setfoundingdate"),
