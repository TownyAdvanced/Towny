...
public enum PermissionNodes {
	...
	TOWNY_COMMAND_ALLIANCE_LIST("towny.command.nation.list.*"),
		TOWNY_COMMAND_ALLIANCE_LIST_RESIDENTS("towny.command.nation.list.residents"),
		TOWNY_COMMAND_ALLIANCE_LIST_TOWNS("towny.command.nation.list.towns"),
		TOWNY_COMMAND_ALLIANCE_LIST_FOUNDED("towny.command.nation.list.founded"),
		TOWNY_COMMAND_ALLIANCE_LIST_NATIONS("towny.command.nation.list.nations"),
		TOWNY_COMMAND_ALLIANCE_LIST_NAME("towny.command.nation.list.name"),
		TOWNY_COMMAND_ALLIANCE_LIST_TOWNBLOCKS("towny.command.nation.list.townblocks"),
		TOWNY_COMMAND_ALLIANCE_LIST_ONLINE("towny.command.nation.list.online"),
