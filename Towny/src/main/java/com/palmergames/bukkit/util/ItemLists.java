...
public class ItemLists extends AbstractRegistryList<Material> {
	...
	public static final ItemLists PLANTS = newBuilder()
			...
			.add("SHORT_GRASS","TALL_GRASS","LARGE_FERN","VINE","TWISTING_VINES_PLANT","WEEPING_VINES_PLANT","NETHER_WART_BLOCK","CRIMSON_ROOTS","WARPED_ROOTS","NETHER_SPROUTS","BIG_DRIPLEAF","SMALL_DRIPLEAF","SHELF_MUSHROOM").build();
