...
public enum ConfigNodes {
	...
	GTOWN_FARM_PLOT_ALLOW_BLOCKS(
			...
			"LONG_GRASS,DOUBLE_PLANT,YELLOW_FLOWER,RED_ROSE,PUMPKIN_STEM,MELON_STEM,BEETROOT_BLOCK,CARROT,POTATO,CROPS,MELON,PUMPKIN,BEETROOT_BLOCK,CHORUS_PLANT,CHORUS_FLOWER,SWEET_BERRY_BUSH,SEAGRASS,TALL_SEAGRASS",
