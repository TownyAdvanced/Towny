...
public class EntityLists extends AbstractRegistryList<EntityType> {
	...
	public static final EntityLists MOUNTABLE = newBuilder().add("horse", "zombie_horse", "skeleton_horse", "strider", "pig", "donkey", "mule", "trader_llama", "camel", "camel_husk", "llama", "happy_ghast", "nautilus").build();
