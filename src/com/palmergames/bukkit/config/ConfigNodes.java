...
//			"# Cost to use /plot set outpost to change a normal plot to a outpost plot."),
	...
	WAR_SIEGE_DEATH_PENALTY_KEEP_INVENTORY_ENABLED(
			...
			"# is a poor design generally, common to inexperienced MC servers, but rare in most online war games:",
			"# e.g.",
			"# * Battlefield, Call-of-duty: Player keeps 'unlocked' equipment e.g. gun types, special grenades etc.",
			"# * League of Legends, Dota: Player keeps 'unlocked' skills/equipment",
			"# * World of Warcraft, Neverwinter, LOTR: Player keeps inventory.",
			"# ",
			"# Configurations:",
			"# True - Expect small/casual nations and players to have an influence of world affairs.",
			"# False - Expect small/casual nations and players to have little influence on world affairs, with large/dedicated nations dominating."),
