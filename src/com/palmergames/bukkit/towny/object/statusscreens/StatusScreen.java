...
public class StatusScreen {
	...
	public void addComponentOf(String name, String text) {
		components.put(name, TownyComponents.miniMessageAndColour(text));
	}
	...
	public void addComponentOf(String name, String text, ClickEvent click) {
		components.put(name, TownyComponents.miniMessageAndColour(text).clickEvent(click));
	}
	
	public void addComponentOf(String name, String text, HoverEvent<?> hover) {
		components.put(name, TownyComponents.miniMessageAndColour(text).hoverEvent(hover));
	}
	
	public void addComponentOf(String name, String text, HoverEvent<?> hover, ClickEvent click) {
		components.put(name, TownyComponents.miniMessageAndColour(text).hoverEvent(hover).clickEvent(click));
	}
