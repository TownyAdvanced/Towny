		...
		if (TownySettings.isJailingAttackingOutlaws()) {
			...
			if (attackerTown.hasOutlaw(defenderResident)) {
				...
				Bukkit.getScheduler().runTaskLater(
					plugin, ()-> 
					JailUtil.jailResidentWithBail(defenderResident, attackerTown.getPrimaryJail(), 0, TownySettings.getJailedPOWJailHours(),TownySettings.getBailAmount(), JailReason.OUTLAW_DEATH, attackerResident.getPlayer()),
					1);
				return;
			}
		}
