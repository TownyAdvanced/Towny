...
public enum ConfigNodes {
	...
	HELPMENU_COLOURS("helpmenu_colours", "", "", "",
			"############################################################",
			"# +------------------------------------------------------+ #",
			"# |                  Help Menu Colouring                 | #",
			"# |                                                      | #",
			"# |  Colour codes used to colour the various help menus  | #",
			"# |  used throughout Towny, seen when doing /command ?   | #",
			"# +------------------------------------------------------+ #",
			"############################################################",
			""),
	HELPMENU_COLOURS_COMMAND("helpmenu_colours.command_colour",
			"&3",
			"",
			"# Colors the command."),
	HELPMENU_COLOURS_SUBCOMMAND("helpmenu_colours.subcommand_colour",
			"&b",
			"",
			"# Colors the subcommand or arguments."),
	HELPMENU_COLOURS_EXPLANATION("helpmenu_colours.explanation_colour",
			"&7",
			"",
			"# Colors the explanation for the command."),
	HELPMENU_COLOURS_REQUIREMENT("helpmenu_colours.requirement_colour",
			"&c",
			"",
			"# Used when a command has a designated requirement, ie: [Admin], preceding the command.",
			"# Rarely used."),
