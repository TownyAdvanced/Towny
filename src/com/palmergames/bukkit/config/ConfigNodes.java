...
public enum ConfigNodes {
	...
	LANGUAGE(
			...
			"# es-419.yml, es-ES.yml, fr-FR.yml, he-IL.yml, id-ID.yml, it-IT.yml, ja-JO.yml,",
	...
	NOTIFICATION_TITLES(
			...
			"# {townname} or {townnameformatted} - Name of the town.",
			...
			"# {nationname} or {nationnameformatted} - Shows the name of the nation the town is in, if the town has a nation. Uses the formatting of notifications.titles.placeholders.nationname.",
	...
	NOTIFICATION_TITLES_PLACEHOLDERS_NATIONNAME(
		"notification.titles.placeholders.nationname",
		"(%s)",
		"",
		"# How the {nationname} placeholder used in titles should be formatted"),
	...
	NOTIFICATION_NOTIFICATIONS_APPEAR_ON_BOSSBAR(
			"notification.notifications_appear_on_bossbar",
			"false",
			"",
