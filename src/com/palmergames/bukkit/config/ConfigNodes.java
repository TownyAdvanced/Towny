...
public enum ConfigNodes {
            ...
            VERSION_BUKKIT("version.bukkit_version","1597", "# Minimum required version of CraftBukkit.  Please do not edit."),
            ...
            FILTERS_MODIFY_CHAT_PER_WORLD("filters_colour_chat.modify_chat.per_world","false",
            		"# If true the chat formats will be copied to each worlds data file",
            		"# These can then be altered individually."),
            FILTERS_MODIFY_CHAT_FORMAT("filters_colour_chat.modify_chat.chat_format",
            		"{worldname}{townytagoverride}{townycolor}{permprefix}{group} {townyprefix}{modplayername}{townypostfix}{permsuffix}&f: {msg}",
            		"# This is the format for when you are not using another plugin to set the format and modify_chat.format is true.",
            		"# This is the format which will be used for Global Chat",
            ...
            FILTERS_MODIFY_CHAT_TAG_FORMAT_WORLD("filters_colour_chat.modify_chat.tag_format.world", "&f[&f%s&f] "),
