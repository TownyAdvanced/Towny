	...
	public void parseToggleCommand(String[] split) throws TownyException {
		...
		if (split[0].equalsIgnoreCase("wildernessuse")) {
			...
			try {
				...
				TownyMessaging.sendMsg(getSender(), Translatable.of("msg_admin_toggle_devmode", (TownySettings.isDevMode() ? Colors.DARK_GREEN + Translatable.of("enabled") : Colors.DARK_RED + Translatable.of("disabled"))));
			} catch (Exception e) {
			...
			try {
				...
				TownyMessaging.sendMsg(getSender(), Translatable.of("msg_admin_toggle_debugmode", (TownySettings.getDebug() ? Colors.DARK_GREEN + Translatable.of("enabled") : Colors.DARK_RED + Translatable.of("disabled"))));
			} catch (Exception e) {
				TownyMessaging.sendErrorMsg(getSender(), Translatable.of("msg_err_invalid_choice"));
			}
			...
			try {
				...
				TownyMessaging.sendMsg(getSender(), Translatable.of("msg_admin_toggle_townwithdraw", (TownySettings.getTownBankAllowWithdrawls() ? Colors.DARK_GREEN + Translatable.of("enabled") : Colors.DARK_RED + Translatable.of("disabled"))));
			} catch (Exception e) {
				TownyMessaging.sendErrorMsg(getSender(), Translatable.of("msg_err_invalid_choice"));
			}
			...
			try {
				...
				TownyMessaging.sendMsg(getSender(), Translatable.of("msg_admin_toggle_nationwithdraw", (TownySettings.getNationBankAllowWithdrawls() ? Colors.DARK_GREEN + Translatable.of("enabled") : Colors.DARK_RED + Translatable.of("disabled"))));
			} catch (Exception e) {
				TownyMessaging.sendErrorMsg(getSender(), Translatable.of("msg_err_invalid_choice"));
			}
