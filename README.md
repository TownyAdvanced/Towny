...
|:----:|:----:|
| MC 1.16.* | Use [0.96.6.0](https://github.com/TownyAdvanced/Towny/releases/tag/0.96.6.0) or the above Latest Pre-Release. |
| MC 1.15.* | Use [0.96.6.0](https://github.com/TownyAdvanced/Towny/releases/tag/0.96.6.0) or the above Latest Pre-Release. |
| MC 1.14.* | Use [0.96.6.0](https://github.com/TownyAdvanced/Towny/releases/tag/0.96.6.0) or the above Latest Pre-Release. |
