...
//		return 0;
	...
	public static double getTownMinWithdraw() {

		return getDouble(ConfigNodes.ECO_MIN_WITHDRAW_TOWN);
	}
	...
	public static double getNationMinWithdraw() {

		return getDouble(ConfigNodes.ECO_MIN_WITHDRAW_NATION);
	}
